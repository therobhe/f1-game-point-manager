			...
			<div className="w-full max-w-4xl relative">
				...
				<div className="text-center mt-16 md:mt-0 mb-16">
					<h1 className="text-4xl md:text-5xl font-black italic tracking-tighter text-white uppercase transform -skew-x-12 inline-block">
						Season
						<span className="block text-red-500 not-italic skew-x-0 tracking-widest text-xl mt-1 uppercase">Configuration</span>
					</h1>
					...
					<div className="flex-1 flex flex-col items-center gap-6 group">
						<button
							...
							className="
								...
								hover:bg-red-700 hover:scale-105 hover:shadow-[0_0_30px_rgba(220,38,38,0.3)]
                                flex items-center justify-center
							"
						>
							<span className="relative z-10 block text-xl font-bold text-white uppercase tracking-wider transform skew-x-12 text-center leading-tight">
								Full 2014<br />Season
							</span>
					...
					<div className="flex-1 flex flex-col items-center gap-6 group">
						<button
							...
							className="
								...
								transform -skew-x-12
								transition-all duration-300 ease-out
								hover:bg-white/10 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.05)]
                                flex items-center justify-center
							"
						>
							<span className="relative z-10 block text-xl font-bold text-white uppercase tracking-wider transform skew-x-12 text-center leading-tight">
				...
				<div className="mt-20 text-center">
					<div className="inline-block p-1 rounded-full bg-white/5 border border-white/10 transition-colors hover:border-red-500/50 cursor-help group">
						<span className="px-4 py-1 text-[10px] uppercase font-bold tracking-[0.2em] text-gray-500 group-hover:text-red-400">
