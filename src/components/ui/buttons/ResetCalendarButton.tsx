...
export const ResetCalendarButton = () => {
	...
	return (
		<button
			...
			"
		>
			<span className="relative z-10 block text-lg font-black italic text-gray-400 group-hover:text-white uppercase tracking-widest transform skew-x-12 transition-colors">
				Reset Calendar
			</span>
