					...
					<table className="w-full text-left border-collapse">
						<thead>
							<tr className="bg-white/5 border-b border-white/10">
								...
								<th className="px-4 py-3 text-xs font-black uppercase tracking-widest text-gray-400 italic text-right">Points</th>
							</tr>
						</thead>
							...
							{driverStandings.map((driver, index) => (
								<tr key={driver.id} className="hover:bg-white/5 transition-colors group">
									...
									<td className="px-4 py-4 text-right">
										<span className="text-xl font-black text-white italic tracking-tighter group-hover:text-red-500 transition-colors">
											{driver.points}
										</span>
									</td>
								</tr>
						...
						<tbody className="divide-y divide-white/5">
							{constructorStandings.map((team, index) => (
								<tr key={team.id} className="hover:bg-white/5 transition-colors group">
									...
									<td className="px-4 py-4">
										<span className="text-white font-bold tracking-tight uppercase">{team.name}</span>
									</td>
									<td className="px-4 py-4 text-right">
										<span className="text-xl font-black text-white italic tracking-tighter group-hover:text-blue-500 transition-colors">
											{team.points}
										</span>
									</td>
								</tr>
